...
export default function NavigationBarButton({title, logoPath, onClick, active = false } : NavigationBarButtonProps){
    return (
        <div
            ...
            onClick={onClick}>
            <a className="flex items-end justify-center text-center mx-auto px-4 pt-2 w-ful
